...
class Scan(ScanData):
    ...
    def __init__(
        ...
        ScanData.__init__(self, image_range, oscillation, exposure_time, epochs, deg)
    ...
    def __add__(self, other):
        ...
        new_image_range = (self.get_image_range()[0], other.get_image_range()[1])
