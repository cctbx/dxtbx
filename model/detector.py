...
class detector:
    ...
    def __init__(
        self, sensor, origin, fast, slow, pixel_size, image_size, trusted_range, mask
    ):
    ...
    def __repr__(self):
        ...
        return (
            start
            + f_3 % self._origin.elems
            + f_3 % self._fast.elems
...
class detector_factory:
    ...
    def XDS(xds_xparm_file):
        ...
        origin = origin_xds - (
            detector_centre[0] * detector_fast + detector_centre[1] * detector_slow
        )
