...
class Experiment:
    ...
    def __contains__(
        self, obj: Union[BeamBase, Detector, Goniometer, Scan, CrystalBase, object]
    ) -> bool: ...
...
class Goniometer(GoniometerBase):
    ...
    def num_scan_points(self) -> int: ...
    @staticmethod
    def from_dict(self, data: Dict) -> Goniometer: ...
    ...
    def set_setting_rotation_at_scan_points(
        self, setting_rotations: List[Vec9Float]
    ) -> Any: ...
    @overload
    def set_setting_rotation_at_scan_points(
        self, setting_rotations: Tuple[Vec9Float, ...]
    ) -> Any: ...
    @overload
    def set_setting_rotation_at_scan_points(
        self, setting_rotations: flex.mat3_double
    ) -> None: ...
    def to_dict(self) -> Dict: ...
...
class VirtualPanelFrame:
    def __eq__(self, other: VirtualPanelFrame) -> bool: ...
    def __ne__(self, other: VirtualPanelFrame) -> bool: ...
...
class PanelData(VirtualPanel):
    ...
    def set_trusted_range(self, range: Vec2Int) -> None: ...
    ...
    def __eq__(self, other: PanelData) -> bool: ...
    def __ne__(self, other: PanelData) -> bool: ...
    def is_similar_to(
        self,
        other: PanelData,
        fast_axis_tolerance: float = ...,
...
class Scan(ScanBase):
    ...
    @staticmethod
    def from_dict(self, data: Dict) -> Scan: ...
    @overload
