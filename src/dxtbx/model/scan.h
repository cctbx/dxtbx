...
namespace dxtbx { namespace model {
  ...
  /** A class to represent a rotational scan */
  class Scan : public ScanBase {
  public:
    /** The default constructor */
    Scan() : oscillation_(0.0, 0.0), exposure_times_(1, 0.0), epochs_(1, 0.0) {}
    ...
    Scan(vec2<int> image_range, vec2<double> oscillation, int batch_offset = 0)
        : ScanBase(image_range, batch_offset),
    ...
    /** Copy */
    Scan(const Scan &rhs)
        : ScanBase(rhs.image_range_, rhs.batch_offset_),
