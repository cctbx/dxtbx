...
class NXmxWriter:
    ...
    def append_frame(self, index=None, data=None):
        ...
        for panel_data in data:
            ...
            elif isinstance(panel_data, (flex.float, flex.double)):
                dataisint.append(False)
            else:
                raise TypeError("Ints or floats/doubles are required")
        assert all(dataisint) or not any(dataisint), "Mix of ints and floats/doubles found"
