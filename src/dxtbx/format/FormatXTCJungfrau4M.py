...
jungfrau_locator_str = """
  jungfrau {
    ...
    monolithic = False
      .type = bool
      .help = switch to FormatXTCJungfrau4MMonolithic if True. Used for LS49 image averaging
    use_big_pixels = True
      .type = bool
...
class FormatXTCJungfrau4M(FormatXTC):
    ...
    def understand(image_file):
        try:
            ...
            return False
        return any("jungfrau4m" in src.lower() for src in params.detector_address)
    ...
    def get_raw_data(self, index=None):
        ...
        d = FormatXTCJungfrau4M.get_detector(self, index)
    ...
    def get_detector(self, index=None):
        return FormatXTCJungfrau4M._detector(self, index)
...
class FormatXTCJungfrau4MMonolithic(FormatXTCJungfrau4M):
...
if __name__ == "__main__":
    for arg in sys.argv[1:]:
        ...
        print(FormatXTCJungfrau4M.understand(arg))
