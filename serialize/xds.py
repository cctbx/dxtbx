...
class to_xds(object):
    ...
    def __init__(self, sweep):
        ...
        R = align_reference_frame(
            self.get_detector().get_fast_axis(),
            (1, 0, 0),
            self.get_detector().get_slow_axis(),
            (0, 1, 0),
        )
        ...
        self.detector_x_axis = (
            R * matrix.col(self.get_detector().get_fast_axis())
        ).elems
        self.detector_y_axis = (
            R * matrix.col(self.get_detector().get_slow_axis())
        ).elems
