...
def datablock_from_dict(obj, check_format=True, directory=None):
    """ Get the datablocks from the dictionary. """

    # If we have a list, extract for each dictionary in the list
    if isinstance(obj, list):
        return [datablock_from_dict(dd, check_format, directory) for dd in obj]
    ...
    for imageset in obj["imageset"]:
        ...
        if ident == "ImageSequence" or ident == "ImageSweep":
            ...
            if "template" in imageset:
                ...
                if "mask" in imageset and imageset["mask"]:
                ...
                if "gain" in imageset and imageset["gain"]:
                ...
                if "pedestal" in imageset and imageset["pedestal"]:
                ...
                if "dx" in imageset and imageset["dx"]:
                ...
                if "dy" in imageset and imageset["dy"]:
...
class DataBlockFactory(object):
    ...
    def from_dict(obj, check_format=True, directory=None):
        ...
        return datablock_from_dict(obj, check_format, directory)
