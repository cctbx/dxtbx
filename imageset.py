...
class SingleFileReader(ReaderBase):
    ...
    def get_image_paths(self, indices=None):
        ...
        filenames = [
            self.get_format().get_image_file(i)
...
class MultiFileState(object):
    ...
    def load_file(self, filename):
        ...
        if self.get_format() == None or filename != self.get_format().get_image_file():
    ...
    def __getstate__(self):
        ...
        return {
            "format_class": self._format_class,
...
class MultiFileReader(ReaderBase):
    ...
    def __init__(self, format_class, filenames, formatchecker=None, format_kwargs=None):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.get_image_paths() == other.get_image_paths()
        )
    ...
    def is_valid(self, indices=None):
        ...
        for index in indices:
            ...
            try:
                format_instance = self.get_format(index)
            except IndexError as RuntimeError:
                return False
...
class ImageSet(object):
    ...
    def __getitem__(self, item):
        ...
        if isinstance(item, slice):
            ...
            subset = ImageSet(
                self.reader(), indices, self._models, format_kwargs=self.format_kwargs()
            )
    ...
    def get_mask(self, index, goniometer=None):
        ...
        if isinstance(self._reader, SingleFileReader):
            dyn_mask = self.get_format(index).get_mask(
                index=index, goniometer=goniometer
            )
        else:
    ...
    def complete_set(self):
        ...
        return ImageSet(
            self.reader(), models=self._models, format_kwargs=self.format_kwargs()
        )
...
class ImageGrid(ImageSet):
    ...
    def __init__(
        self, reader, indices=None, models=None, grid_size=None, format_kwargs=None
    ):
        """Initialise the ImageSet object.
        ...
        super(ImageGrid, self).__init__(
            reader, indices, models, format_kwargs=format_kwargs
        )
...
class SweepFileList(object):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.array_range() == other.array_range()
        )
...
class ImageSetFactory(object):
    ...
    def new(filenames, check_headers=False, ignore_unknown=False):
        ...
        for filelist in filelist_per_imageset:
            try:
                imagesetlist.append(
                    ImageSetFactory._create_imageset_or_sweep(filelist, check_headers)
                )
    ...
    def make_imageset(
        ...
        # Return the imageset
        return ImageSet(
            reader, indices=single_file_indices, format_kwargs=format_kwargs
        )
