...
class FormatHDF5EigerNearlyNexus(FormatHDF5):
    ...
    def _start(self):
        ...
        reader = nexus.NXmxReader(handle=fixer.handle)
        ...
        data = nexus.NXdata(fixer.handle_orig[entry.data[0].handle.name])
        ...
        self._scan_models = nexus.scan_factory(sample, detector)
